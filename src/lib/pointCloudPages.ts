...
export const PAGE_POINT_CLOUDS: Record<string, RoutePointCloudConfig> = {
  ...
  "/settings": {
    label: "点云设置 / Calibration",
    pcdUrl: "/models/cube.bin",
    targetRadius: 5,
